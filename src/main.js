...
import SAM_ALT_IMG from '../ft/Sam (Guyiday).png';
import JIJ_ALT_IMG from '../ft/Jij (Guyiday).png';
...
function avatarEl(who) {
  const isAlt = $("app").classList.contains("theme-alt");
  const img = document.createElement("img");
  img.className = "avatar";
  if (who === "ai") {
    img.src = isAlt ? SAM_ALT_IMG : SAM_IMG;
    img.alt = "Sam";
  } else {
    img.src = isAlt ? JIJ_ALT_IMG : JIJ_IMG;
    img.alt = "Jij";
  }
  return img;
}
...
if (savedTheme === "alt") appEl.classList.add("theme-alt");

$("themeToggle").addEventListener("change", (e) => {
  if (e.target.checked) {
    appEl.classList.add("theme-alt");
    localStorage.setItem("aibuddy_theme", "alt");
  } else {
    appEl.classList.remove("theme-alt");
...
$("openSettings").addEventListener("click", () => {
  ...
  $("themeToggle").checked = appEl.classList.contains("theme-alt");
